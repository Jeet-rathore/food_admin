...
class EditRiderScreen extends StatefulWidget {
  @override
  _EditRiderScreenState createState() => _EditRiderScreenState();
}
...
class _EditRiderScreenState extends State<EditRiderScreen> {
  ...
  void initState() {
    ...
    _firstNameController.text = 'Raj';
    _lastNameController.text = 'Joshith';
    _emailController.text = 'raj.joshith@email.com';
    _contactController.text = '+91 91234 56789';
    _emergencyController.text = '+91 91234 56790';
    _doorNoController.text = '123';
    _streetController.text = 'Main Street';
    _areaController.text = 'City Center';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            CommonHeader(title: 'Edit Ryder', icon: Icons.motorcycle),
  ...
  void _updateRider() {
    // Here you would typically update the rider data in a database
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
